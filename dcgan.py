...
dis_optimizer = optimizers.Adam(4e-5,0.5)
optimizer = optimizers.Adam(4e-4,0.5)
#dis_optimizer = optimizers.Adam(1e-3,0.5)
#optimizer = optimizers.Adam(1e-5,0.5)
...
G.add(Dense(4096, input_dim=latent_dim))
G.add(BatchNormalization())
G.add(LeakyReLU(0.2))
G.add(Reshape((8, 8, 64)))
...
D.add(Conv2D(64, 5, strides=2, padding="same", input_shape=(64,64,3)))
